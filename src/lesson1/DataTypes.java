...
public class DataTypes {
    public static void main(String[] args) {
        System.out.println("INTEGRER DATA TYPES");
        byte b = 127;
        short s = 32;
        int i = 1;
        long l = -356;

        System.out.println("Byte type: has 8 bits, can have the value in range from from -128 to 127. " +
                "Example: b = " + b);
        System.out.println("Short type: has 16 bits, can have the value in range from from  -32,768 to 32,767. " +
                "Example: s = "+ s);
 ...
 //       char c = 65;
        ...
        System.out.println("LOGICAL DATA TYPES");
                ...
                System.out.println("Logical type " +
                        "example: tr = " + tr);
                System.out.println("Logical type " +
                        "example: 1000 >=8 is  " + (1000 >=8));

                if (fal != tr) System.out.println( "you have the same values");
