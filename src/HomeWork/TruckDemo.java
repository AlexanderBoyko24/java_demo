...
с использованием конструктора этого класса. */
 ...
 class TruckDemo {
    public static void main (String [] args){
        ...
        System.out.println("For going a " + dist + " miles Truck needs " + gallons + " gallons of fuel.\n");

        gallons = pickup.fuelneeded(dist);

        System.out.println("Pickup can carry " + pickup.getCargo() + " pounds. ");
        System.out.println("For going a " + dist + " miles Pickup needs " + gallons + " gallons of fuel");
