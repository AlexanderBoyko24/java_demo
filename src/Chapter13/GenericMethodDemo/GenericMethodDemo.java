package Chapter13.GenericMethodDemo;
...
// Массивы, имеющие разную длину, не могут быть одинаковыми
    ...
    public static void main(String[] args) {
        ...
        if (arraysEqual(nums, nums))
            System.out.println("nums is equal to nums");

        if (arraysEqual(nums, nums2))
            System.out.println("nums is equal to nums2");

        if (arraysEqual(nums, nums3))
            System.out.println("nums is equal to nums3");

        if (arraysEqual(nums, nums4))
            System.out.println("nums is equal to nums4");
