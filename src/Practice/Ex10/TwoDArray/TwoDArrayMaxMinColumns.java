...
public class TwoDArrayMaxMinColumns {
    ...
    public static void main(String[] args) {
        ...
        // Находим минимальный и максимальный элементы для каждой колонки
    ...
    public static void findMinMaxForEachColumn(int[][] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            int min = array[0][i]; // предполагаем, что первый элемент в колонке - минимальный
            int max = array[0][i]; // предполагаем, что первый элемент в колонке - максимальный

            // Находим минимальный и максимальный элементы в текущей колонки
            ...
            // Выводим минимальный и максимальный элементы для текущей колонки
